...
export default function TeamDetail() {
  ...
  return (
    <>
      <Breatcamp page={teamMember.name} />
      <div className="team-details-area space overflow-hidden">
        <div className="container container2">
          <div className="row justify-content-between">
            <div className="col-lg-4">
              <div className="team-page-single">
                <div className="page-img mb-40">
                  <img src={teamMember.image} alt={teamMember.name} width={'100%'} />
                </div>
              </div>
            </div>
            <div className="col-lg-8">
              <div className="team-info-wrapper">
                <h2 className="team-details-title">{teamMember.name}</h2>
                <h3 className="team-details-designation">{teamMember.designation}</h3>
                <p>{teamMember.content1}</p>
