                ...
                />
                  ...
                  <div class="post-content-tags ">
                    <div class="post-tag-social">
                      <div class="post-tag">
                        <a class="btn style5 style-r0" onClick={handleShow}>
                          Enquiry Now<i class="fas fa-angle-double-right"></i>
                        </a>
                      </div>
                    </div>
                  </div>
