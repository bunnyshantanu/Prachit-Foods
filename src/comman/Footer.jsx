...
export default function Footer() {
  return (
    ...
    <>
        ...
        <footer class="footer-wrapper footer-layout4 overflow-hidden background-image position-relative">
              ...
              <div class="widget-contact">
                ...
                <div className="row">
                  ...
                  <div class="contact-info-card col-lg-12">
                    ...
                    <div class="info-card_content">
                      <p class="info-card_title">Hours
                      </p>
                      <h4 class="info-card_text">Mon - Sat: 11:00AM - 06:00PM .<br />
                      Sunday: Closed</h4>
                    </div>
                  </div>
                </div>
